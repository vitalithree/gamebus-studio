...
import { AdminChallengeCuPage } from './admin-challenge-cu.page';

const routes: Routes = [
  {
    path: '',
    component: AdminChallengeCuPage
  }
];
...
@NgModule({
  ...
  declarations: [AdminChallengeCuPage]
})
export class AdminChallengeCuPageModule { }
