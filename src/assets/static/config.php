...
$auth_users = array(
	'admin' => '$2y$10$5jJjrqVs6uFYsZZsiuF7EO4cBB5/gEQXFv9NsLkJJQw2sPlJYLCTy', //protectedassets
	'user' => '$2y$10$ywRJOY1fQA5BQapRMBDqH.UnzSHSZK.lEZppGNzZR93NYDPs6t9Du' //readonly
);
...
$root_path = $_SERVER['DOCUMENT_ROOT'] . '/assets/static';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/assets/static';
